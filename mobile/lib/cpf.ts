// Espelho de app/portal/lib/cpf.ts (web/). Normalização, validação de dígito
// verificador e o e-mail sintético usado para autenticar no Supabase com CPF
// (Supabase Auth exige e-mail único; nem todo funcionário tem e-mail
// cadastrado). Mantenha os dois arquivos em sincronia.
