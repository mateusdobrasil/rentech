        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-6">
            ...
            <p className="text-xs text-[#64748B] mb-4">
              Puxa direto do PrimeStart (produção) as contas a pagar em aberto com vencimento a partir de 180 dias atrás (mais todas as futuras). Sem tela de upload manual — essa integração é só via API.
            </p>
            <button
