...
// Interface tipando o que vem do banco de dados
...
export default function Home() {
  ...
  // Estado Inicial com os dados originais (Fallback seguro)
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await enviarOrcamento(formData);
  ...
  // Lógica para manter o estilo visual do título: separa as duas últimas palavras para ficarem em azul
  const tituloPalavras = config.hero_titulo.split(' ');
  const tituloAzul = tituloPalavras.slice(-2).join(' ');
  const tituloBranco = tituloPalavras.slice(0, -2).join(' ');
        ...
        <div className="container mx-auto px-6 relative z-10 text-center md:text-left flex flex-col md:flex-row items-center">
          <div className="md:w-2/3">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight tracking-tighter">
              {tituloBranco} <br/>
              <span className="text-[#336699]">{tituloAzul}</span>
            </h1>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0C1D4D]/20 border border-[#284B8C]/30 rounded-xl overflow-hidden hover:border-[#336699] transition-all hover:-translate-y-2 group">
              <div className="relative h-56 overflow-hidden bg-[#0C1D4D]/50">
                <img
                  src={config.img_feiras}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start max-w-6xl mx-auto">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">{config.email_contato}</p>
                  </div>
                </a>
              </div>
            </div>

            {/* Formulário de orçamento (Server Actions) */}
            <form
            ...
            >
              ...
              {formStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-900/50 border border-green-500 rounded-lg text-green-400 font-semibold text-center">
                  ✅ Solicitação enviada com sucesso! Entraremos em contato em breve.
                </div>
              )}

              {formStatus === 'error' && (
                <div className="mb-6 p-4 bg-red-900/50 border border-red-500 rounded-lg text-red-400 font-semibold text-center">
                  ❌ Houve um erro ao enviar. Tente novamente ou use nosso WhatsApp.
                </div>
              )}
              ...
              <div className="flex flex-col gap-5">
                ...
                <button
                  ...
                  className="w-full bg-[#284B8C] text-white px-8 py-4 rounded-md text-base font-black hover:bg-[#336699] hover:shadow-lg hover:shadow-[#284B8C]/40 transition-all uppercase tracking-wide disabled:opacity-50"
                >
      ...
      <footer className="w-full px-6 py-10 mt-auto bg-gradient-to-t from-[#000000] to-transparent border-t border-[#0C1D4D]/50">
        <div className="flex flex-col items-center gap-6 max-w-4xl mx-auto">
          <div className="flex gap-4">
            ...
            <a href="https://x.com/LocadoraRentech" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-full bg-[#0C1D4D]/30 border border-[#284B8C]/30 text-[#999999] hover:text-[#336699] hover:border-[#336699] hover:bg-[#336699]/10 hover:-translate-y-1 transition-all duration-300">
