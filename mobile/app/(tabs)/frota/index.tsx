  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.container}>
      <View style={styles.card}>
        <Text style={styles.cardTitulo}>Checklist de veículo</Text>
        <Text style={styles.cardTexto}>Saída, retorno, foto e GPS chegam na Fase 2. Placeholder por enquanto.</Text>
      </View>
    </ScrollView>
  );
}
